...
/**
 * Pint of Blood (Screening) RH Positive
 * Price: 35,000
...
@AllArgsConstructor
@Entity
@DiscriminatorValue("BLOOD_SCREENING_RH_POSITIVE")
public class BloodScreeningRHPositiveTest extends LabTest {
    ...
    private String referenceRange = """
        ...
        Rh Type: Positive
        Note: Complete blood screening for transfusion safety
        """;
    ...
    public void initializeDefaults() {
        if (super.getName() == null) {
            super.setName("PINT OF BLOOD (SCREENING) RH POSITIVE");
        }
